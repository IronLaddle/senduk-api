...
@Component
public class ApreloadData implements ApplicationListener<ContextRefreshedEvent> {
	 ...
	 @Autowired
	 public void setToiletRepository(RepoToilet toiletRepository) {
        this.toiletRepository = toiletRepository;
	 }
	 
	 @Autowired
	 public void setToiletUserRepository(RepoToiletUser toiletUserRepository) {
        this.toiletUserRepository = toiletUserRepository;
	 }
	 
	@Override 
	public void onApplicationEvent(ContextRefreshedEvent arg0) {
		
		ModelToilet toilet = new ModelToilet();
		...
		if(toiletRepository.findByName("Tandas Klia 1") == null) {
			toilet.setName("Tandas Klia 1");
			toilet.setImage("http://www.hawkrentacar.com.my/wp-content/uploads/2016/06/OneRepublic-in-Malaysia-Arrive-KLIA-from-Singapore-7824_0.jpg");
			toilet.setLocation("KLIA Airport");
			toilet.setPrice(5);
			toilet.setUsed(75);
			toilet.setRating(4);
			toilet.setDuration(1);
			toilet.setDescription("Toilet saya ini telah menjadi toilet kegemaran warga KL yang inginkan bersendiririan. Mereka boleh melayari internet secara percuma");
			toilet.setToiletOwnerID(0);
